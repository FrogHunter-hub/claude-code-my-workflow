...
\note{Define the unit of observation: firm $\times$ technology $\times$ quarter.  Define key variables: shares of each macro-cause and macro-effect category, total snippet count, cause-to-effect ratio.  Provide summary statistics (Table~II).  Discuss how firms discussing multiple technologies are handled.  Follow the compact Table~I/Table~II format from Hassan et al.\ (2019).}
...
\note{Decompose the variation in cause and effect shares into time FE, technology FE, sector FE, sector $\times$ time FE, and firm FE.  Report incremental $R^2$ from each set of fixed effects (Table~V).  The key finding: after absorbing technology--time and industry--time effects, a large share of variance remains and is captured by firm FE.  \textbf{This is the analog of Table VIII in Hassan et al.\ (2019), which was the central new finding of that paper.}  Follow that table's format exactly.  Present results at different levels of industry granularity (2-digit, 3-digit, 4-digit SIC) as in the political risk paper.  \textbf{This test is the lynchpin.  If the firm component is small, the belief-style story weakens.  Run this early.}}
...
\begin{tabular}{lccc}
\hline\hline
\multicolumn{1}{l}{Industry granularity} & 2-digit SIC & 3-digit SIC & 4-digit SIC \\
& (1) & (2) & (3) \\
\hline
\multicolumn{4}{l}{\textsc{Panel A. Cause (mean across shares)}}\\
Time FE                    & 1.89\% & 1.97\% & 1.91\% \\
Industry FE                & 4.70\% & 6.23\% & 7.57\% \\
Industry $\times$ time FE  & 6.32\% & 8.99\% & 12.37\% \\
Technology FE              & 13.08\% & 12.00\% & 11.18\% \\
Technology $\times$ time FE& 6.92\% & 6.83\% & 6.95\% \\
``Firm-level''             & 67.09\% & 63.97\% & 60.02\% \\
\quad \parbox[t]{0.62\linewidth}{Permanent differences across firms\\within industries (Firm FE)}
                           & 18.55\% & 17.25\% & 16.39\% \\
\quad \parbox[t]{0.62\linewidth}{Time-varying firm component\\(residual)}
                           & 48.54\% & 46.72\% & 43.63\% \\
Number of industries       & 32 & 63 & 94 \\
\hline
\multicolumn{4}{l}{\textsc{Panel B. Effect (mean across shares)}}\\
Time FE                    & 1.17\% & 1.16\% & 1.20\% \\
Industry FE                & 3.12\% & 4.55\% & 5.49\% \\
Industry $\times$ time FE  & 6.21\% & 8.80\% & 11.83\% \\
Technology FE              & 10.74\% & 9.82\% & 9.15\% \\
Technology $\times$ time FE& 5.14\% & 5.12\% & 5.17\% \\
``Firm-level''             & 73.62\% & 70.55\% & 67.15\% \\
\quad \parbox[t]{0.62\linewidth}{Permanent differences across firms\\within industries (Firm FE)}
                           & 18.34\% & 16.96\% & 16.13\% \\
\quad \parbox[t]{0.62\linewidth}{Time-varying firm component\\(residual)}
                           & 55.28\% & 53.59\% & 51.03\% \\
Number of industries       & 51 & 128 & 173 \\
\hline\hline
\end{tabular}

\vspace{0.25em}
\begin{flushleft}\footnotesize
\textit{Notes.} This table shows tabulations of the $R^{2}$ from projections of the cause (Panel A) and effect (Panel B) shares in a firm--technology--quarter cell on various sets of fixed effects. Column (1) corresponds to the specification using two-digit SIC industries. Columns (2) and (3) use three-digit and four-digit SIC industries, respectively. The ``firm-level'' variation is between 60\% and 74\% across the three columns.
\end{flushleft}
\end{table}
...
% Acemoglu, Daron, and Joshua Linn, ``Market Size in Innovation: Theory and Evidence from the Pharmaceutical Industry,'' \textit{Quarterly Journal of Economics}, 119 (2004), 1049--1090.

% \bibitem[Ben-David, Graham, and Harvey(2013)]{BenDavid2013}
% Ben-David, Itzhak, John~R. Graham, and Campbell~R. Harvey, ``Managerial Miscalibration,'' \textit{Quarterly Journal of Economics}, 128 (2013), 1547--1584.

% \bibitem[Bloom et~al.(2018)]{Bloometal2018}
% Bloom, Nicholas, Erik Brynjolfsson, Lucia Foster, Ron Jarmin, Megha Patnaik, Itay Saporta-Eksten, and John Van~Reenen, ``What Drives Differences in Management Practices?'' \textit{American Economic Review}, 109 (2019), 1648--1683.

% \bibitem[Bordalo, Gennaioli, and Shleifer(2018)]{BordaloGennaioli2018}
% Bordalo, Pedro, Nicola Gennaioli, and Andrei Shleifer, ``Diagnostic Expectations and Credit Cycles,'' \textit{Journal of Finance}, 73 (2018), 199--227.

% \bibitem[Coibion, Gorodnichenko, and Kumar(2018)]{Coibion2018}
% Coibion, Olivier, Yuriy Gorodnichenko, and Saten Kumar, ``How Do Firms Form Their Expectations? New Survey Evidence,'' \textit{American Economic Review}, 108 (2018), 2671--2713.

% \bibitem[Gennaioli and Shleifer(2010)]{GennaioliShleifer2010}
% Gennaioli, Nicola, and Andrei Shleifer, ``What Comes to Mind,'' \textit{Quarterly Journal of Economics}, 125 (2010), 1399--1433.

% \bibitem[Gennaioli and Shleifer(2018)]{GennaioliShleifer2018}
% Gennaioli, Nicola, and Andrei Shleifer, \textit{A Crisis of Beliefs: Investor Psychology and Financial Fragility} (Princeton, NJ: Princeton University Press, 2018).

% \bibitem[Griliches(1957)]{Griliches1957}
% Griliches, Zvi, ``Hybrid Corn: An Exploration in the Economics of Technological Change,'' \textit{Econometrica}, 25 (1957), 501--522.

% \bibitem[Hall(2006)]{Hall2006}
% Hall, Bronwyn~H., ``Innovation and Diffusion,'' in Jan Fagerberg, David~C. Mowery, and Richard~R. Nelson, eds., \textit{The Oxford Handbook of Innovation} (Oxford: Oxford University Press, 2006).

% \bibitem[Hassan et~al.(2019)]{Hassanetal2019}
% Hassan, Tarek~A., Stephan Hollander, Laurence van~Lent, and Ahmed Tahoun, ``Firm-Level Political Risk: Measurement and Effects,'' \textit{Quarterly Journal of Economics}, 134 (2019), 2135--2202.

% \bibitem[Hassan et~al.(2023)]{Hassanetal2023RFS}
% Hassan, Tarek~A., Stephan Hollander, Laurence van~Lent, Markus Schwedeler, and Ahmed Tahoun, ``Firm-Level Exposure to Epidemic Diseases: COVID-19, SARS, and H1N1,'' \textit{Review of Financial Studies}, 36 (2023), 4919--4964.

% \bibitem[Hsieh and Klenow(2009)]{HsiehKlenow2009}
% Hsieh, Chang-Tai, and Peter~J. Klenow, ``Misallocation and Manufacturing TFP in China and India,'' \textit{Quarterly Journal of Economics}, 124 (2009), 1403--1448.

% \bibitem[Kalyani et~al.(2025)]{Kalyanietal2025}
% Kalyani, Aakash, Nicholas Bloom, Marcela Carvalho, Tarek Hassan, Josh Lerner, and Ahmed Tahoun, ``The Diffusion of New Technologies,'' \textit{Quarterly Journal of Economics}, 140 (2025), 1299--1365.

% \bibitem[Malmendier and Tate(2005)]{Malmendier2005}
% Malmendier, Ulrike, and Geoffrey Tate, ``CEO Overconfidence and Corporate Investment,'' \textit{Journal of Finance}, 60 (2005), 2661--2700.

% \bibitem[Mansfield(1961)]{Mansfield1961}
% Mansfield, Edwin, ``Technical Change and the Rate of Imitation,'' \textit{Econometrica}, 29 (1961), 741--766.

% \bibitem[Sautner et~al.(2023)]{Sautneretal2023}
% Sautner, Zacharias, Laurence van~Lent, Grigory Vilkov, and Ruishen Zhang, ``Firm-Level Climate Change Exposure,'' \textit{Journal of Finance}, 78 (2023), 1449--1498.
